...
{
    fprintf(stream, "Usage : snake2025 <options>\n"
...
{
    char *message = mur ? "Vous avez perdu !\nVous vous êtes pris un mur." : "Vous avez perdu !\nVotre serpent s'est mordu la queue.";
    ...
    while (MLV_get_event(&touche, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL) == MLV_NONE || touche != MLV_KEYBOARD_ESCAPE)
    {
        ...
        MLV_draw_filled_rectangle(x, y, largeur_boite, hauteur_boite, MLV_COLOR_LIGHT_GREEN);
        MLV_draw_rectangle(x, y, largeur_boite, hauteur_boite, MLV_COLOR_BLACK);

        if (win)
        {
            MLV_draw_text_box(
                x, y, largeur_boite, hauteur_boite,
                "Vous avez gagné !", 9,
                MLV_COLOR_BLACK, MLV_COLOR_WHITE, MLV_COLOR_LIGHT_GREEN,
